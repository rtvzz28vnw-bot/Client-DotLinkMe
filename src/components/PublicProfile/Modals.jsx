        ...
        <div className="p-6">
          {hasNativeShare && (
            <button
              ...
              className="w-full mb-4 py-3 bg-purple-500 text-white font-semibold rounded-xl hover:bg-purple-600 transition-all flex items-center justify-center gap-2"
            >
